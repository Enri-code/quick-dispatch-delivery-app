      ...
      <div className="px-3 py-2">
        ...
        <div className="grid grid-cols-4 gap-2 mb-3">
          {quickActions.map((action) => (
            ...
            >
              <div className={`w-8 h-8 rounded-full flex items-center justify-center mb-1 ${action.color}`}>
        ...
        <div className="grid grid-cols-2 gap-2 mb-2">
          <Button
            onClick={onCallRider}
            className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white py-2.5 rounded-lg shadow-md flex items-center justify-center space-x-2"
          >
          ...
          <Button
            ...
            className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white py-2.5 rounded-lg shadow-md flex items-center justify-center space-x-2"
          >
